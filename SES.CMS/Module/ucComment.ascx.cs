...
namespace SES.CMS.Module
{
    public partial class ucComment : System.Web.UI.UserControl
    {
        ...
        protected void btnSend_Click(object sender, EventArgs e)
        {
            ...
            {
                Ultility.Alert("Vui lòng điền họ tên");
            ...
            {
                Ultility.Alert("Vui lòng điền email");
                txtEmail.Focus();
                return;
            }
            if (txtContent.Text.Trim().Equals(""))
            {
                ScriptManager.RegisterClientScriptBlock(this.Page, this.Page.GetType(), "alert", "alert('Vui lòng nhập nội dung!');", true);
                txtContent.Focus();
                return;
            }
